...
public class GeoData implements Serializable {
    ...
    public String toString() {
        return "GeoData{" + "\n"+
                ...
                ", engTotalHours=" + engTotalHours + "\n"+
                ", engTotalHoursTimestamp=" + engTotalHoursTimestamp + "\n"+
                ", vehicleSpeed=" + vehicleSpeed + "\n"+
                ", vehicleSpeedTimestamp=" + vehicleSpeedTimestamp + "\n"+
                ", engineRpm=" + engineRpm + "\n"+
                ", engineRpmTimestamp=" + engineRpmTimestamp + "\n"+
                ", fuelLevel=" + fuelLevel + "\n"+
                ", fuelLevelTimestamp=" + fuelLevelTimestamp + "\n"+
                ", latitude=" + latitude + "\n"+
                ", longitude=" + longitude + "\n"+
                ", gpsHeading=" + gpsHeading + "\n"+
                ", gpsTime=" + gpsTime + "\n"+
                ", timeStamp=" + timeStamp + "\n"+
                ", totalUdrvEvents=" + totalUdrvEvents + "\n"+
                ", unidentifiedEventArrayList=" + unidentifiedEventArrayList + "\n"+
                ", dataSet=" + dataSet + "\n"+
                '}';
    }
}