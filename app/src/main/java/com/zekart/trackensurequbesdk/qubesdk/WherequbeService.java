...
import com.zekart.trackensurequbesdk.qubesdk.custom.TrackerQubeWrapper;
...
public class WherequbeService {
    ...
    private TrackerQubeWrapper wrapper = null;
    ...
    protected ServiceConnection mServiceConnection = new ServiceConnection() {
        public void onServiceConnected(ComponentName className, IBinder rawBinder) {
            ...
            mServiceBound = true;
            wrapper.onServiceConnected(className,rawBinder);
        ...
        public void onServiceDisconnected(ComponentName classname) {
            ...
            mServiceBound = false;
            wrapper.onServiceDisconnected(classname);
        }
    };
    ...
    public WherequbeService(TrackerQubeWrapper wrapper){
